...
public class AdminUserController {
    ...
    @ResponseBody
    public ServerResponse systemLogin(HttpServletRequest request, HttpServletResponse response, Admin_User adminUser, @RequestParam(required = false) Integer remind){
        HttpSession session=request.getSession(true);
