...
<div class="layui-tab layui-tab-brief" style="margin: 0; height: 99.9%;" lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        ...
        <shiro:hasPermission name="user:verify">
            <li>普通用户管理</li>
        </shiro:hasPermission>
    </ul>
        ...
        <div class="layui-tab-item layui-show" style="height: 94%;">
            <div class="usertools">
                <div class="questionnaire-search" style="float:left; margin-top: -23px;">
                    ...
                    <div onclick="adminUserSearch()" class="questionnaire-search-button"><img
                            src="img/icon/icon-search.png"></div>
                </div>
                <shiro:hasPermission name="admin:delete">
                    <img src="img/icon/icon-delete.png" data-type="checkAdminData" class="demoTable" alt="删除选中管理员"
                         title="删除">
                </shiro:hasPermission>
        ...
        <div class="layui-tab-item" style="height: 93%">
            <div class="usertools">
                <div class="questionnaire-search" style="float:left; margin-top: -23px;">
                    ...
                    <div onclick="userSearch()" class="questionnaire-search-button"><img src="img/icon/icon-search.png">
                    </div>
                </div>
                <shiro:hasPermission name="user:delete">
                    <img src="img/icon/icon-delete.png" data-type="checkUserData" class="userTableDel" alt="删除选中普通用户"
                         title="删除">
                </shiro:hasPermission>
...
//        管理员动态表格
        ...
        userTable = table.render({
            ...
            cols: [[{width: layui_tab_item_width * 0.02, checkbox: true},
                ...
                {
                    width: layui_tab_item_width * 0.14,
                    fixed: 'right',
                    align: 'center',
                    toolbar: '#userToolBar',
                    title: '操作'
