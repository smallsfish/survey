...
<div class="questionnaire-top">
    <div class="questionnaire-search" style="float:left; margin-left: 25px;">
        ...
        <div onclick="searchSuccessVideo()" class="questionnaire-search-button"><img src="img/icon/icon-search.png"></div>
    </div>
...
//        动态表格
    ...
    function searchSuccessVideo(){
        var schoolName=$(":input[name='vname']").val();
        if(schoolName===""){
            layer.msg("请输入视频标题！",{icon:2,time:3000});
            return;
        }
        successVideoTable.reload({
            url:'system/searchVideoList?schoolname='+schoolName
        });
    }
